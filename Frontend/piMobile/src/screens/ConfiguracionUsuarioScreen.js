  ...
  return (
    <MainLayout title="Configuración" navigation={navigation} backTo="Dashboard" activeTab="ConfiguracionUsuario">
      <View style={styles.card}>
        ...
        <TouchableOpacity style={styles.item} onPress={() => navigation.navigate('Notificaciones')}><Text style={styles.itemText}>Notificaciones</Text><Text style={styles.arrow}>Abrir</Text></TouchableOpacity>
