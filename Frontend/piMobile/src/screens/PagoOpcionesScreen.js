...
export default function PagoOpcionesScreen({ navigation }) {
  return (
    <MainLayout title="Pago" navigation={navigation} backTo="Dashboard" activeTab="RastrearEnvio">
      <View style={styles.card}>
        <TouchableOpacity style={styles.item} onPress={() => navigation.navigate('PagoTarjeta')}>
          <Text style={styles.itemText}>Tarjeta</Text>
          <Text style={styles.arrow}>Elegir</Text>
        </TouchableOpacity>

        <TouchableOpacity style={styles.item} onPress={() => navigation.navigate('PagoConfirmacion')}>
          <Text style={styles.itemText}>Transferencia</Text>
          <Text style={styles.arrow}>Elegir</Text>
        </TouchableOpacity>

        <TouchableOpacity style={styles.itemLast} onPress={() => navigation.navigate('PagoConfirmacion')}>
