  ...
  return (
    <MainLayout title="Pago" navigation={navigation} backTo="PagoOpciones" activeTab="RastrearEnvio">
      <View style={styles.card}>
        <View style={styles.rowWrap}><Text style={styles.rowStrong}>Tarjeta</Text><Text style={styles.chip}>Elegido</Text></View>
        <Text style={styles.row}>Visa **** 7835</Text>
        <Text style={styles.row}>Titular: Carlos Ramirez</Text>
      </View>

      <View style={styles.card}>
        <TextInput style={styles.input} placeholder="EXVV / mm/yy / CVV" placeholderTextColor="#9AA4BF" />
